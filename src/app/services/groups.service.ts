...
export class GroupsService {
  ...
  searchGroups(term: string): Observable<any[]> {
    ...
    return this.http.get<any[]>(`/groups/?group[name]=${term}`).pipe(
  ...
  addGroup(group): Observable<any> {
    return this.http.post(`/groups`, group).pipe(
  ...
  deleteGroup(group): Observable<any> {
    ...
    return this.http.delete(`/groups/${id}`).pipe(
  ...
  updateGroup(group): Observable<any> {
    return this.http.put(`/groups/${group.id}`, group).pipe(
